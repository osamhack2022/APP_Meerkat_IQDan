...
import { Text, StyleSheet, View, ScrollView, Animated, TextInput, Button, Image, Keyboard, TouchableOpacity, DeviceEventEmitter } from 'react-native';
import AsyncStorage from '@react-native-async-storage/async-storage';
// type
import { MainTabScreenProps, RootStackParamList, TabParamList, User, UserEvent } from '../common/types.d';
  ...
  return (
    <View style={{width: "100%", height: "100%"}}>
      <SafeAreaView>
        ...
        { notFound && <Text style={{fontSize: 24, alignSelf: "center"}}>유저를 찾을 수 없습니다.</Text> }
        { added && <Text style={{fontSize: 24, alignSelf: "center"}}>해당 유저를 전우로 추가하였습니다.</Text> }
        { user && 
          <View>
            ...
            <View style={styles.userInfoSection}>
              ...
              <View style={styles.row}>
                <TouchableOpacity onPress={addAsFriend}>
                  <MaterialIcons size={48} name='person-add' />
                </TouchableOpacity>
              </View>
            </View>
          </View> 
